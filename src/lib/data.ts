...
const currentDate = new Date().getDate(); // current day of the month
...
export const calendarEvents = [
  ...
  },
  {
    ...
    end: new Date(currentYear, currentMonth, currentDate - 5, 9, 45),
  },

  {
    ...
    end: new Date(currentYear, currentMonth, currentDate - 5, 11, 45),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(currentYear, currentMonth, currentDate - 5, 13, 0),
    end: new Date(currentYear, currentMonth, currentDate - 5, 13, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(currentYear, currentMonth, currentDate - 5, 14, 0),
    end: new Date(currentYear, currentMonth, currentDate - 5, 14, 45),
  }
];
